    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btnClickme:
                ...
                Toast.makeText(getActivity(),"Thank you for using this मेरो Todo List App.",Toast.LENGTH_LONG).show();
                break;

            case R.id.btnCallme:
                startActivity(new Intent(Intent.ACTION_DIAL, Uri.parse("tel:9807535240")));
                break;
